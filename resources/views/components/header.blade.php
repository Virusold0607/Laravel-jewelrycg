<header class="navbar navbar-expand-lg">
    ...
    <nav class="container">
        ...
        <a class="nav-link notification-badge-container" aria-current="page" id="navbarDropdownNoti" role="button" data-bs-toggle="dropdown" aria-expanded="false" href="#">
        ...
        @auth
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link notification-badge-container" aria-current="page" id="navbarDropdownNoti"
                        ...
                        <ul class="dropdown-menu half-menu dropdown-menu-end" aria-labelledby="navbarDropdownNoti">
                        ...
                        <ul class="dropdown-menu small-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <div class="d-flex align-items-center py-3">
                                ...
                                <div class="fs-14 mr-10px border-right">
                                    ...
                                    <div class="data"><a class="text-primary" href="{{ route('logout') }}">Sign out</a></div>
                                </div>
                            </div>
