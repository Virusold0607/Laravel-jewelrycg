<x-app-layout>
                                ...
                                <div class="js-add-field card mb-3 mb-lg-5">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <select name="attributes[]" id="attributes" value="" class="form-control form-control-sm select2" multiple="multiple" style="width: 100%;">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="values[]" id="product_attribute_values" value="" class="form-control form-control-sm select2" multiple="multiple" style="width: 100%;">
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="tags[]" id="tags" value="" class="form-control form-control-sm select2" multiple="multiple" style="width: 100%;">
                                        @foreach ($tags as $tag)
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#gallery_dropzone").dropzone({
                ...
                init: function() {
                    ...
                    for (const gallery of galleries) {
                        ...
                        var mockFile = {
                            name: gallery.file_original_name,
            ...
            $("#3dpreview_dropzone").dropzone({
                ...
                init: function() {
                    ...
                    if (preview && preview.id) {
                        ...
                        var mockFile = {
                            name: preview.file_original_name
                        };
            ...
            $("#thumbnail_dropzone").dropzone({
                ...
                init: function() {
                    ...
                    if (thumbnail.id) {
                        var mockFile = {
                            name: thumbnail.file_original_name,
        ...
        }) var digital_download_assets = []; $('#getFileManagerModel').click(function() {
            $.ajax({
                url: "{{ route('backend.file.show') }}",
                success: function(data) {
                    if (!$.trim($('#fileManagerContainer').html()))
        ...
        var digital_assets = []; $('#getFileManagerAsset').click(function() {
            $.ajax({
                url: "{{ route('backend.file.show') }}",
                success: function(data) {
                    if (!$.trim($('#fileManagerContainer').html()))
