@extends('backend.layouts.app', ['activePage' => 'services', 'title' => 'All service', 'navName' => 'allservice', 'activeButton' => 'service'])
...
<div class="page-header mb-4">
    ...
    <div class="row align-items-center mb-3">
        ...
        <!-- <div class="col-sm-auto">
            <a class="btn btn-primary" href="{{ route('backend.services.create') }}">Create service</a>
        </div> -->
        <!-- End Col -->
    </div>
    <!-- End Row -->
                        ...
                        <tbody>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a class="btn btn-dark btn-sm" href="{{ route('backend.services.edit', $service->id) }}">Edit</a>
                                    <!-- Button Group -->
                                    <div class="btn-group">
